...
import org.arenzhj.erp.system.model.User;
import org.arenzhj.erp.system.service.EchoService;
...
public class EchoControler {
	...
	@RequestMapping(value="/indexTab", method=RequestMethod.GET)
	public String indexTab(
		...
		if(StringUtils.equals("bootstrapTable", fileName)){
	...
	@ResponseBody
	public String dbInit(Model model) {
//		model.addAttribute("fileName", fileName);
		return "success";
	}
